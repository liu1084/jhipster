...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "springboot_test2@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "springboot_test2 API";

        private String description = "springboot_test2 API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "springboot_test2";
